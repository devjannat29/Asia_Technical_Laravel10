...
class HomeController extends Controller
{
    ...
    public function event_details($id){
        ...
        ->take(6);
        $overses_gallery= OverseasGallery::all();
        return view('frontend.pages.event_details',compact('events','course','latestservice','latest_notice','gallery','latest_interview','overses_gallery'));
    }
    ...
    public function notice(){
        ...
        ->get()
        ->take(6);
        return view('frontend.pages.notice',compact('course','latestservice','notice','gallery','latest_interview','latest_notice'));
    }
    ...
    public function interview(){
        ...
        ->get()
        ->take(6);
        return view('frontend.pages.interview',compact('course','latestservice','interview','gallery','latest_interview','latest_notice'));
    }
