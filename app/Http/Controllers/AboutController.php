...
class AboutController extends Controller
{
    ...
    public function upload_member(Request $request){
        ...
        return redirect()->route('admin.view_member')->with('success','Member Added'); 
    }
    ...
    public function update_member(Request $request,$id){
        ...
        return redirect()->route('admin.view_member')->with('success','Member Update'); 
    }
    ...
    public function delete_member($id){
        ...
        return redirect()-> back()->with('warning','Member Deleted Successfully');
    }
