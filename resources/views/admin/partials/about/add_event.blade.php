...
<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
      <div>
        <h4 class="mb-3 mb-md-0">Add Event</h4>
      </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h6 class="card-title mb-3" style="font-size: large;">Add Event</h6>
                <form class="forms-sample" action="{{ route('admin.upload_event') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
