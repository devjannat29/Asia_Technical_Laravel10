                    ...
                    <table id="dataTableExample" class="table">
                      ...
                      @foreach ($service as $services)
                        <tr>
                          ...
                          <td><a href="{{route('admin.edit_service',$services->id)}}"><i style="color: green" data-feather="edit"></i></a></td>
                          <td><a href="{{route('admin.delete_service',$services->id)}}" onclick="showSwal('passing-parameter-execute-cancel')"> <i style="color: red" data-feather="x-circle"></i></a></td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
